...
proc sql;
	create table hchzb_sum as select jl,yhczdsly 'CRA已核查字段数量',xhczdzsl 'CRA需核查字段数量' from dp.hchzb where xhczdzsl>yhczdsly;
quit;
...
/*sum(xhczdzsl)-sum(yhczdsly) as unsdv,*/
/*sum(yhczdsly) as  yhczdsly,*/
/*sum(xhczdzsl) as  xhczdzsl */
/*from dp.unsdv_cra*/
/*group  by siteid*/
/*order by siteid*/
/*;*/
