...
DATA abs_final;
	...
	keep tid siteid subjid lockstat sitename   visit visitnum svnum yhczdsle xhczdzsle creator createtime modify modifytime WARNING x length;
run;
proc sql;
...
data edc.unsdv_dm(rename=(tid1=tid visit1=visit svnum1=svnum var_11=var_1 ));
...
proc sql;
create table  edc.unsdv_dm1 as 
select 
a.*,b.mchcat,coalescec(c.hbvcat,d.hbvcat) as hbvcat
from edc.unsdv_dm as a
